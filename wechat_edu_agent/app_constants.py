...
# Review thresholds
ARTICLE_WORD_COUNT_MIN = 1600
ARTICLE_WORD_COUNT_MAX = 2200
ARTICLE_WORD_COUNT_TARGET = 2000
ARTICLE_WORD_COUNT_REVIEW_MAX = 2400
MAX_REVIEW_ROUNDS = 5

# Per-section word count targets (article structure)
SECTION_NEWS_INTRO = 200
SECTION_REVERSE_QUESTION = 300
SECTION_SURFACE_ANALYSIS = 300
SECTION_DEEP_ANALYSIS = 400
SECTION_PARENT_ANXIETY = 300
SECTION_ADVICE_TOTAL = 400
SECTION_ADVICE_EACH_MIN = 100
SECTION_ADVICE_EACH_MAX = 200
SECTION_ENDING = 100